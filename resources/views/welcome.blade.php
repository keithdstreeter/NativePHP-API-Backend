...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="max-w-md w-full bg-white rounded-xl shadow-md p-6 text-center items-center">
        <!-- App Header -->

        {{-- <div class="min-h-screen flex flex-col items-center justify-center px-1 py-1">

            <img src="{{ asset('images/logo.png') }}" alt="FLT Logo" class="img-fluid img-scale mb-1"
                style="max-width: 200px;">

        </div> --}}

        <h1 class="text-2xl font-bold text-gray-800 mb-2">D2R2-2026 Android App</h1>
        <img src="{{ asset('images/logo.png') }}" alt="FLT Logo" class="img-scale mb-1">
