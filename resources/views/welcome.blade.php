...
<body>
    <h1 id="privacy-policy-for-d2r2-ride-app">Privacy Policy for D2R2 Ride App</h1>
    <p><strong>Effective Date: August 13, 2026</strong></p>
    <p>The <strong>D2R2 Ride App</strong> (&quot;the App&quot;) is built and maintained as a commercial service. This
        privacy policy informs you of our practices regarding the collection, use, and disclosure of personal data when
        you use the App.</p>
    <h2 id="1-no-data-collection-by-the-developer">1. No Data Collection by the Developer</h2>
    <p>We value your trust and privacy. The App <strong>does not collect, harvest, store, transmit, or share any
            personal data</strong> from its users. You are not required to create an account, register, or provide any
        personal information to use the features of the App.</p>
    <h2 id="2-third-party-services-push-notifications">2. Third-Party Services &amp; Push Notifications</h2>
    <p>While the App itself does not collect personal data, it utilizes <strong>Google Firebase</strong> to deliver
        automated push notifications. </p>
    <ul>
        <li><strong>Data Involved:</strong> Google Firebase may automatically process non-identifying technical data,
            such as a temporary Firebase installation ID or device token. This is strictly required to route
            notifications to your specific device.</li>
        <li><strong>No Personal Tracking:</strong> This identifier is not linked to your personal identity, name, email,
            or physical location.</li>
        <li><strong>Privacy Link:</strong> You can review how your device interacts with this service by visiting the <a
                href="https://policies.google.com/privacy">Google Privacy &amp; Terms</a>.</li>
    </ul>
    <h2 id="3-device-permissions-revoking-consent">3. Device Permissions &amp; Revoking Consent</h2>
    <p>To receive push notifications, the App will request your explicit permission. You remain in complete control of
        this access:</p>
    <ul>
        <li>You can <strong>grant or deny</strong> this permission when launching the App for the first time.</li>
        <li>You can <strong>revoke your consent</strong> at any time by disabling notifications through your iOS device
            settings (<strong>Settings &gt; D2R2 Ride App &gt; Notifications</strong>).</li>
    </ul>


    <h2 id="5-changes-to-this-privacy-policy">5. Changes to This Privacy Policy</h2>
    <p>We may update our Privacy Policy from time to time. You are advised to review this page periodically for any
        changes. Changes are effective immediately upon posting.</p>
    <h2 id="6-contact-us">6. Contact Us</h2>
    <p>If you have any questions or suggestions about this Privacy Policy, do not hesitate to contact us at [Your
        Contact Email/Website URL].</p>
